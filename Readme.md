...
|           k-12 \|\| Final-Act \|\| Tgt-GIOUd-Cos6            | 46.84 | 50.88 | 43.29 | 54.62 | 45.09 | 69.26 | 60.19 | 81.98 |
|            k-12 \|\|Final-Act \|\|Tgt-GIOUd-Cosd6            | 46.88 | 50.78 | 43.43 | 54.39 | 44.90 | 68.97 | 60.18 | 81.99 |
|                  k-12+Final+Max-GIOUd-Cos6                   | 47.72 | 50.84 | 44.75 | 55.75 | 46.02 | 70.69 | 60.19 | 81.98 |
|                  k-12+Final+Max-GIOUd-Cosd6                  | 46.80 | 50.52 | 43.52 | 54.69 | 45.13 | 69.39 | 60.03 | 82.00 |
|                   Fast Reid(2) + LayerNorm                   | 47.41 | 50.78 | 44.42 | 55.56 | 45.86 | 70.45 | 60.28 | 82.00 |
...
|                    Conditions +[Mask-50]                     | HOTA  | DetA  | AssA  | IDF1  |  IDR  |  IDP  | MOTA  | MOTP  |
| :----------------------------------------------------------: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|         GraphConv-woloop+bigger<br>match-thresh: 0.3         | 49.34 | 50.47 | 48.37 | 58.65 | 48.08 | 75.17 | 59.96 | 82.17 |
|  GraphConv-woloop + bigger<br>graphnorm + affinity \|\| 0.4  | 50.60 | 50.58 | 50.74 | 60.89 | 49.89 | 78.11 | 60.27 | 82.19 |
|           如上的配置，只不过边用layernorm \|\| 0.4           | 50.18 | 50.57 | 49.90 | 60.12 | 49.26 | 77.11 | 60.27 | 82.20 |
|                  全部使用batchnorm \|\| 0.4                  | 50.26 | 50.43 | 50.23 | 60.28 | 49.40 | 77.30 | 60.31 | 81.18 |
|                HiOU \|\| norm 方式和best一致                 | 50.65 | 50.60 | 50.82 | 60.91 | 49.91 | 78.15 | 60.30 | 82.19 |
|               4090中训练 二阶段<br> thresh:0.4               | 50.69 | 50.63 | 50.87 | 61.18 | 50.12 | 78.51 | 60.36 | 82.19 |
|                使用三阶段 \|\| w-0.6 thre 0.7                | 50.77 | 50.68 | 50.98 | 61.21 | 50.20 | 78.41 | 60.40 | 82.15 |
| 4090中将best模型的edge&Node encoder中relu改成lrelu,使用track_old代码进行测试 | 50.66 | 50.56 | 50.87 | 61.02 | 49.99 | 78.30 | 60.36 | 82.15 |
|    按照上一行配置，如果dynamic graph按照余弦距离进行构图     | 50.87 | 50.62 | 51.22 | 61.57 | 50.44 | 79.02 | 60.39 | 82.19 |
|             如上配置，但是去掉一个dynamic graph              | 51.09 | 50.67 | 51.62 | 61.71 | 50.61 | 79.07 | 60.43 | 82.17 |
|               如上配置，再去掉一个static graph               | 50.51 | 50.56 | 50.57 | 60.85 | 49.91 | 77.93 | 60.38 | 82.13 |
|             在一个dg的前提下，corr -> $\sqrt{d}$             | 49.87 | 50.56 | 49.31 | 59.70 | 48.91 | 76.60 | 60.27 | 82.20 |
|                        dg+batch-bug?                         | 50.38 | 50.62 | 50.27 | 60.82 | 49.84 | 78.00 | 60.34 | 82.20 |
|                        edge-graphnorm                        | 50.79 | 50.56 | 51.14 | 61.47 | 50.37 | 78.83 | 60.36 | 82.20 |
|                        edge-nodenorm                         | 50.29 | 50.59 | 50.12 | 60.27 | 49.38 | 77.32 | 60.23 | 82.19 |
|                           自注意力                           | 48.24 | 50.39 | 46.31 | 57.35 | 46.97 | 73.63 | 59.89 | 82.18 |
|                           pe[add]                            | 50.55 | 50.52 | 50.69 | 61.03 | 50.00 | 78.30 | 60.24 | 82.19 |
|                       自注意力+linear                        | 47.61 | 50.43 | 45.05 | 56.35 | 46.16 | 72.33 | 59.96 | 82.14 |
|                           mask-40                            | 48.57 | 50.54 | 46.76 | 58.24 | 47.71 | 74.74 | 60.24 | 82.18 |
|                       mask before affi                       | 50.65 | 50.63 | 50.78 | 61.04 | 50.01 | 78.30 | 60.40 | 82.20 |
|                 GIOU \|\| norm方式和best一致                 |  NaN  |       |       |       |       |       |       |       |
|                        增加Dice Loss                         | 50.08 | 50.59 | 49.70 | 59.66 | 48.90 | 76.50 | 60.30 | 82.19 |
|                             k-4                              |       |       |       |       |       |       |       |       |
|                          before kf                           | 45.17 | 50.23 | 40.65 | 52.43 | 42.96 | 67.24 | 59.63 | 82.02 |
|                           After kf                           | 47.53 | 52.24 | 43.35 | 52.60 | 43.08 | 67.53 | 59.24 | 85.02 |

| Conditions | HOTA  | DetA  | AssA  | IDF1  |  IDR  |  IDP  | MOTA  | MOTP  |
| :--------: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|  Mask-50   | 44.40 | 50.66 | 39.11 | 50.57 | 41.75 | 64.12 | 59.17 | 81.95 |
|  Mask-55   | 50.64 | 50.64 | 50.76 | 61.05 | 50.04 | 78.29 | 60.42 | 82.19 |

在3090上进行测验，修复了res_layer的batch缺失问题，MASK-50 && track_old 中 0.4 0.6 0.7 0.1 结果如下

|   Conditions    | HOTA  | DetA  | AssA  | IDF1  |  IDR  |  IDP  | MOTA  | MOTP  |
| :-------------: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| Origin[w Batch] | 50.64 | 50.62 | 50.78 | 60.84 | 49.84 | 78.08 | 60.34 | 82.21 |
|  MaskAfterAffi  | 50.67 | 50.63 | 50.82 | 61.08 | 50.04 | 78.38 | 60.36 | 82.19 |

- 发现把Mask放在AffinityLayer之前，是可以略微提高下模型性能

现在打算在3090上尝试一下，HOTA51的模型性能，即除了edgeEncoder以外，其他边都是graphnorm



在4090上进行测试，修复了res_layer的batch缺失问题，且进行对边使用graphnorm实验[edge_batch是图 ],MASK-50，&& track_old 0.4 0.6 0.7 0.1

|             Conditions             | HOTA  | DetA  | AssA  | IDF1  |  IDR  |  IDP  | MOTA  | MOTP  |
| :--------------------------------: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 这里还差个edgeencoder没有graphnorm | 51.22 | 50.57 | 51.99 | 62.07 | 50.85 | 79.63 | 60.34 | 82.19 |
|               无向图               | 50.39 | 50.52 | 50.38 | 60.59 | 49.64 | 77.75 | 60.32 | 82.16 |
|       边全grapnorm,且有向图        | 50.49 | 50.63 | 50.46 | 60.77 | 49.79 | 77.95 | 60.34 | 82.20 |

发现 无向图会恶化网络，而且edgeEncoder中如果也用graphnorm来的话，也会恶化。
